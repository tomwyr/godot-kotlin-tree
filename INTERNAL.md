...
To build the example project against plugin's local version, uncomment `pluginManagement` in [settings.gradle.kts](example/settings.gradle.kts) and remove plugin's version in [build.gradle.kts](example/build.gradle.kts).
